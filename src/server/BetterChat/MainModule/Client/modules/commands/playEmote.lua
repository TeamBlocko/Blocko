-- Original source written by: TheGamer101
-- I semi-modified it to my needs.

--[[
	This module allows you to run emotes via the chat.
]]
...
return function(message)
	...
	local systemMessage = function(message)
		shared.better_chat.messageCreators.systemMessage(message,"all");
	end
