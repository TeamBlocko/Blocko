...
export type PlacementSettingsActions = 
	ActionRecievedUpdateProperty | ActionRecievedUpdateSettings | ActionRecievedUpdateFunctionality | ActionRecievedUpdateFunctionalityProperty;
...
export function updateFunctionality(guid: string, value: Functionalities.FunctionalitiesInstances): ActionRecievedUpdateFunctionality & AnyAction {
	return {
...
export function updateFunctionalityProperty(guid: string, property: string, value: number): ActionRecievedUpdateFunctionalityProperty & AnyAction {
	return {
...
export const placementSettingsReducer = createReducer<PlacementSettings, PlacementSettingsActions>(
	intialPlacementSettings,
	{
		...
		[ActionTypes.UPDATE_FUNCTIONALITY]: (state, action) => {
			...
			const functionalityIndex = newState.Functionalities.findIndex(functionality => functionality.GUID === action.guid)
		...
		[ActionTypes.UPDATE_FUNCTIONALITY_PROPERTY]: (state, action) => {
			...
			const property = (values(functionality.Properties) as Functionalities.FunctionalitiesPropertiesInstance[] ).find(property => property.Name === action.property)
